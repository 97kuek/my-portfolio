...
description: 'XROTORのAEROSECTIONパラメータをXFLR5の解析データから自動算出するツールの開発背景と理論について解説します。'
pubDate: '2025-09-28'
...
どんなアプリかと言いますと、**プロペラ設計ソフトXROTOR**のAEROSECTIONのパラメータ設定を自動化するツールです。[リポジトリ](https://github.com/97kuek/xflr5-to-xrotor-converter)のリンクを貼っておきますので、ぜひご参照ください。
