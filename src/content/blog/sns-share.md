...
よく使われるSNSの「宛先」と「書き方」をまとめました。

| SNS | シェア用URLの形式 |
| --- | --- |
| **X (旧Twitter)** | `https://twitter.com/share?url={URL}&text={タイトル}&hashtags={タグ}` |
| **Facebook** | `https://www.facebook.com/sharer/sharer.php?u={URL}` |
| **LINE** | `https://social-plugins.line.me/lineit/share?url={URL}` |
| **はてなブックマーク** | `https://b.hatena.ne.jp/entry/{URL}` <br>

<br>※`https://`を除いたURLを指定する場合もありますが、最近はパネル型も主流です |
